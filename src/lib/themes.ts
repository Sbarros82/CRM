...
export const THEMES: ReadonlyArray<ThemeMeta> = [
  ...
  },
  {
    id: "emerald",
    name: "Esmeralda",
    tagline: "Codificado para crescimento, remete ao WhatsApp sem copiá-lo.",
    swatch: "oklch(0.62 0.16 162)",
  },
  {
    id: "cobalt",
    name: "Cobalto",
    tagline: "Azul SaaS B2B limpo — calmo e focado no produto.",
    swatch: "oklch(0.585 0.2 254)",
  },
  {
    id: "amber",
    name: "Dourado",
    tagline: "Quente e amigável — ideal para equipes de pequenos negócios.",
    swatch: "oklch(0.745 0.16 65)",
  },
  {
    id: "rose",
    name: "Rosa",
    tagline: "Ousado e moderno — D2C, economia criativa e lifestyle.",
