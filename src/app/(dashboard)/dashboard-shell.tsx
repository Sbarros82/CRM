...
function DashboardShellInner({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-background">
      ...
      {/* Mount only on desktop — avoids duplicate Realtime channels with MobileBottomNav. */}
      {desktop ? <Sidebar open={sidebarOpen} onClose={closeSidebar} /> : null}
