...
const EDITABLE_ROLES: { value: AccountRole; label: string; hint: string }[] = [
  ...
  { value: 'agent', label: 'Agente', hint: 'Usar funcionalidades; sem acesso a configurações' },
  { value: 'viewer', label: 'Visitante', hint: 'Somente leitura no aplicativo' },
];
        ...
        <div>
          ...
          {invitations.length > 0 ? (
            <p className="mb-3 text-xs text-muted-foreground">
              ...
              por segurança — para reenviar, revogue o convite abaixo e
              crie um novo.
            </p>
          ) : null}
        ...
        <DialogContent className="bg-popover border-border sm:max-w-sm">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground">
              ...
              e receberá uma conta pessoal nova no próximo acesso. Seu
              login não é excluído.
            </DialogDescription>
          </DialogHeader>
