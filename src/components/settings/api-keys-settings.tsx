      ...
      <SettingsPanelHead
        ...
        description={
          <>
            ...
            <code className="text-xs">/api/v1</code>) para que você possa criar suas próprias
            automações. Envie-as como{' '}
        ...
        {createdKey ? (
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-muted-foreground">
                Nomeie-a com o nome da integração que a utilizará e conceda apenas
