...
export function ProfileForm() {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(
        emailSent
          ? 'Perfil salvo — verifique seu e-mail para confirmar a mudança de endereço'
          : 'Perfil salvo',
      );
    } catch (err) {
  ...
  return (
    <section className="max-w-2xl animate-in fade-in-50 duration-200">
      <SettingsPanelHead
        title="Seu perfil"
        description="Como você aparece no aplicativo. Seu avatar e nome aparecem no cabeçalho, barra lateral e em qualquer lugar que seus colegas possam ver."
      />
