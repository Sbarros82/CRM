...
const DEFAULT_MESSAGES: Message[] = [
  {
    text: "Oi! Vocês fazem landing page?",
    sender: "them",
    timestamp: "10:14",
  },
  {
    text: "Sim — um consultor monta a proposta. Enquanto isso, posso te mostrar o CRM no WhatsApp.",
    sender: "me",
    timestamp: "10:15",
  },
  {
    text: "Perfeito. Quero falar com alguém do time.",
    sender: "them",
    timestamp: "10:16",
  },
];
      ...
      {[0, 1, 2].map((i) => (
        <span
          ...
          style={{
            ...
            height: 7,
            borderRadius: "50%",
            backgroundColor: isMe ? "rgba(26, 26, 26, 0.55)" : "#8E8E93",
      ...
      {showTyping && (
        ...
        >
          ...
          >
            <TypingBubble
              bubbleColor={
                isTypingFromMe ? sentBubbleColor : receivedBubbleColor
              }
              isMe={isTypingFromMe}
            />
          </div>
