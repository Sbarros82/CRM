...
const audienceOptions: {
...
}[] = [
  {
    ...
    description: 'Enviar para todos os contatos da base',
    icon: Users,
  },
  {
    type: 'tags',
    label: 'Filtrar por etiquetas',
    description: 'Alcançar contatos com etiquetas específicas',
    icon: Tags,
  },
  {
    type: 'custom_field',
      ...
      {audience.type === 'custom_field' && (
        <div className="space-y-3 rounded-xl border border-border bg-card/50 p-4">
          ...
          {loadingFields ? (
            ...
            <p className="text-xs text-muted-foreground">
              Nenhum campo personalizado. Crie um em Configurações → Campos personalizados.
            </p>
          ) : (
